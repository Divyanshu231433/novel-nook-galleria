      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container px-4 md:px-6 max-w-md mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-2xl md:text-3xl font-serif font-medium text-bookish-ink">Create Your Account</h1>
            <p className="text-muted-foreground mt-2">Join NovelNook and discover your next favorite book</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-muted-foreground">
                ...
                <Link to="/login" className="text-bookish-accent hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
